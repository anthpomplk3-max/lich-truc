...
try:
    ...
    with st.sidebar:
        ...
        **Quy tắc xếp lịch:**
        ...
        6. Người công tác: không tham gia trực (mỗi ngày công tác = 2 công)
    ...
    def generate_advanced_schedule(month, year, training_day, day_off_dict, business_trip_dict, line_inspection_groups, balance_shifts=True):
        ...
        for staff in all_staff:
            ...
            business_credits = business_days * 2  # Mỗi ngày công tác = 2 công
    ...
    with tab3:
        ...
        if st.session_state.schedule_created and st.session_state.staff_stats:
            ...
            for staff, data in st.session_state.staff_stats.items():
                ...
                business_credits = data.get('business_credits', 0)  # Công công tác
            ...
            total_business_credits = total_business * 2  # Mỗi ngày công tác = 2 công
    ...
    st.markdown("---")
    st.caption("""
    **Hệ thống xếp lịch trực TBA 500kV - Phiên bản 8.1 - Đã sửa lỗi ngày 31 và người công tác**  
    *Mỗi người: 17 công/tháng = 1 công đào tạo + công kiểm tra + công công tác + công trực ca*  
